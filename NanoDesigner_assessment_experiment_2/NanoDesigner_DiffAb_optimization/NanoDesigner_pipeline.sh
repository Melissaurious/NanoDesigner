...
CONFIG="${PROJECT_DIR}/config_files/NanoDesigner_diffab_optimization_1CDR.yml"
MAIN_FOLDER="${PROJECT_DIR}/NanoDesigner_assessment_experiment_2/NanoDesigner_DiffAb_optimization"
