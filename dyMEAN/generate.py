...
from data.pdb_utils import VOCAB, Residue, Peptide, Protein, AgAbComplex, AgAbComplex_mod
from utils.logger import print_log
from utils.random_seed import setup_seed


def to_cplx(ori_cplx, ab_x, ab_s) -> AgAbComplex_mod:
