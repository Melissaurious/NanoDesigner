...
# FoldX
FOLDX_BIN = './NanoDesigner/foldx5Linux64/foldx_20241231'


# DockQ 
# IMPORTANT: change it to your path to DockQ project)
DOCKQ_DIR = './NanoDesigner/DockQ'
# cache directory
...
IGFOLD_DIR = '/home/rioszemm/NanoDesigner/IgFold'
IGFOLD_CKPTS = None  # 'None' means using the default checkpoints
# 4.2 docking
HDOCK_DIR = '/home/rioszemm/NanoDesigner/HDOCKlite-v1.1'
# 4.3 CDR generation models
MEAN_DIR = './NanobodiesProject/MEAN'
Rosetta_DIR = './NanoDesigner/rosetta.binary.linux.release-351/main/source/bin'
DiffAb_DIR = '.NanoDesigner/diffab'