...
# FoldX
FOLDX_BIN = './foldx_1Linux64/foldx_20251231'
# DockQ 
...
#  CDR generation models
Rosetta_DIR = './rosetta.binary.linux.release-351/main/source/bin'
DiffAb_DIR = './diffab'


#  configs related to data process
...
#. antibody numbering, [start, end] of residue id, both start & end are included
#  IMGT numbering definition
class IMGT:
    # heavy chain
    HFR1 = (1, 26)
    HFR2 = (39, 55)
