...
if __name__ == '__main__':
    ...
    # /ibex/user/rioszemm/NANOBODY_ANTIBODY_clustered_CDRH3_DIFFAB
    fold = "9"
    # current_folder = "/ibex/user/rioszemm/april_2024_Diffab_NB_AG_clst_AG_3_cdrs"
    current_folder = "/ibex/user/rioszemm/april_2024_DIFFAB_nano_clst_Ag"
    # current_folder = "/ibex/user/rioszemm/april_2024_DiffAb_NANO_clst_cdrh3"
    # current_folder = "/ibex/user/rioszemm/april_2024_Nb_Ab_DIFFAB_clst_cdh3"
    valid_json_file= f"/ibex/user/rioszemm/Final_datasets_march_2024/Nanobody_antigen_clst/fold_{fold}/valid.json"
    # valid_json_file= f"/ibex/user/rioszemm/Final_datasets_march_2024/Nb_Ab_clst_cdrh3/fold_{fold}/valid.json"
    train_json_file= f"/ibex/user/rioszemm/Final_datasets_march_2024/Nanobody_antigen_clst/fold_{fold}/train.json"

    # now_training = f"Nb_Ab_fold_{fold}"
    # now_training = f"nano_AB_fold_{fold}_clustered_CDRh3"
    ...
    #Single design
    parser.add_argument('config', type=str, default="/ibex/user/rioszemm/NanobodiesProject/diffab/configs/train/codesign_multicdrs.yml")

    # Multiple design
    # parser.add_argument('--config', type=str, default="/home/rioszemm/NanobodiesProject/diffab/configs/train/codesign_multicdrs.yml")

    # parser.add_argument('--resume', type=str, default="/ibex/user/rioszemm/april_2024_DiffAb_NANO_clst_cdrh3/fold_4/checkpoints/6000.pt")  # TO CONTINUE TRAINING FROM LAST CKPT
    ...
    # args.resume = "/ibex/user/rioszemm/NANOBODY_CLUSTERED_CDRH3_DIFFAB/fold_3/checkpoints/177000.pt"
    ...
    if args.debug:
        ...
        ckpt_dir = current_folder + f"/fold_{fold}/checkpoints"
    ...
    # processed_dir = f"/ibex/user/rioszemm/NANOBODY_DATASET_CLUSTERED_Ag_DIFFAB/fold_{fold}/processed_nanobodies"
    
    processed_dir = current_folder + f"/fold_{fold}/processed_entries"

    # processed_dir = f"/ibex/user/rioszemm/NANOBODY_CLUSTERED_CDRH3_DIFFAB/fold_{fold}/processed_nanobodies"
    tsv_file = '/ibex/user/rioszemm/all_structures/sabdab_summary_all-5.tsv'  # not necessary if training myself
    # chothia_dir = '/ibex/user/rioszemm/all_structures/chothia'  # also may not be necessary if training myself
    chothia_dir = "/ibex/user/rioszemm/Final_datasets_march_2024/all_pdbs_chothia"
